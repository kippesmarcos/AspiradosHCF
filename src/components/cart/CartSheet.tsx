import { ShoppingCart, Trash2, CreditCard, Package, CreditCard as PaymentIcon } from 'lucide-react';
            ...
            <div className="border-t border-beige-900/50">
              ...
              <div className="p-6 bg-beige-900/20 space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between text-sm">
                    <span className="text-beige-400">Impuestos IVA</span>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <Button
                    variant="outline"
                    className="w-full border-beige-900 text-beige-400 hover:bg-beige-900/30"
                    onClick={clearCart}
                  >
                    <Trash2 className="w-4 h-4 mr-2" />
                    Vaciar
                  </Button>
                  <Button className="w-full bg-beige-400 hover:bg-beige-500 text-black">
